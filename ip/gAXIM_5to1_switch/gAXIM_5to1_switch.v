...
`define IP_UUID _6c84bb3879f34eb5b704451e997ba7b5
`define IP_NAME_CONCAT(a,b) a``b
`define IP_MODULE_NAME(name) `IP_NAME_CONCAT(name,`IP_UUID)
module gAXIM_5to1_switch
(
    input rst_n,
    input clk,
    ...
    input [14:0] s_axi_wuser,
    output [14:0] s_axi_buser,
