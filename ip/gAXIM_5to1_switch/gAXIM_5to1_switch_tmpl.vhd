...
component gAXIM_5to1_switch is
port (
    rst_n : in std_logic;
    clk : in std_logic;
    ...
    s_axi_awprot : in std_logic_vector(19 downto 0);
    ...
    s_axi_arprot : in std_logic_vector(19 downto 0);
    ...
    s_axi_wuser : in std_logic_vector(14 downto 0);
    s_axi_buser : out std_logic_vector(14 downto 0);
    s_axi_ruser : out std_logic_vector(14 downto 0)
);
end component gAXIM_5to1_switch;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_gAXIM_5to1_switch : gAXIM_5to1_switch
port map (
    rst_n => rst_n,
    clk => clk,
