...
module apb3_slave #(
	...
	output  [1:0]		        clkmux_sel,
    output  [31:0]              tx_packet_count,
    output                      mac_sw_rst,
    output                      phy_sw_rst,
	//
	input				        clk,
...
///////////////////////////////////////////////////////////////////////////////
	...
	assign clkmux_sel[0] 	= slaveReg[0][0];
	assign clkmux_sel[1] 	= slaveReg[0][1];
    assign tx_packet_count  = slaveReg[1];
    assign mac_sw_rst       = slaveReg[2][0];
    assign phy_sw_rst       = slaveReg[2][1];
	//
endmodule
