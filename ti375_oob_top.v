...
// Array geometry of the StalyaNPU instance below. The file is generated by
// "python -m stalyanpu project apply" in ip/stalyanpu; change the geometry
// with that command and rebuild the bitstream.
`include "rtl/snpu_config.vh"
...
snpu_top #(
    .N_CHAIN       ( `SNPU_CFG_N_CHAIN ),
    .CHAIN_LEN     ( `SNPU_CFG_CHAIN_LEN ),
    .P_MAX         ( `SNPU_CFG_P_MAX ),
    .P_W           ( `SNPU_CFG_P_W ),
    .IBUF_WORDS    ( `SNPU_CFG_IBUF_WORDS ),
    .IBUF_AW       ( `SNPU_CFG_IBUF_AW ),
    .WFIFO_WORDS   ( `SNPU_CFG_WFIFO_WORDS ),
    .WFIFO_AW      ( `SNPU_CFG_WFIFO_AW ),
    .OC_MAX        ( `SNPU_CFG_OC_MAX ),
    .AXI_DW        ( `SNPU_CFG_AXI_DW ),
    .WR_SLOT_WORDS ( `SNPU_CFG_WR_SLOT_WORDS ),
    .MP_MAX_W      ( `SNPU_CFG_MP_MAX_W ),
    .MP_W_AW       ( `SNPU_CFG_MP_W_AW )
) u_snpu (
    .clk       ( io_ddrMasters_0_clk ),
    .rst       ( npu_rst ),
    .paddr_i   ( npu_paddr ),
